<nav class="navbar navbar-expand-lg navbar-light bg-white">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto mr-5">
        @if (Auth::user() -> name == 'jason')
          <li class="nav-item mr-4">
            <a href="{{ route('lara-admin-mb') }}"  class="btn btn-info" type="button">Dashboard</a>
          </li>
        @endif
        ...
        <ul class="navbar-nav ml-auto mr-5"> 
            <li class="nav-item dropdown mr-3">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span type="button" class="fas fa-user fa-sm text-success" ></span>
                </a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <p class="dropdown-item">{{auth::user()->name }} : connecté  <span class="fas fa-circle text-success"></span>  </p>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="{{route('logout')}}">Deconnection</a>
                </div>
              </li>
