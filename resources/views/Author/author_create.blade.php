    ...
    <div class="">
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <form method="POST" action="{{ route('author.store') }}" class="col-md-12 col-lg-12"  enctype="multipart/form-data">
                    @csrf
                    <fieldset disabled>
                    ...
                    <textarea class="form-control" name="description" placeholder="menber description" id="exampleFormControlTextarea1" rows="5"></textarea>
                    <div class="form-group">
